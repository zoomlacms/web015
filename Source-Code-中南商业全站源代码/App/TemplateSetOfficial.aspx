<%@ page language="C#" autoeventwireup="true" enableviewstatemac="false" inherits="App_TemplateSetOfficial, App_Web__az9qmx6" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<html>
<head runat="server">
<title>方案列表</title>
...
<form id="form1" runat="server">
  ...
  <%} %> 后台管理&gt;&gt;系统设置&gt;&gt;<a href="<%=PageAction.customPath2+"Template/TemplateSet.aspx" %>">方案设置</a>&gt;&gt;<a href="<%=PageAction.customPath2+"Template/CloudLead.aspx" %>">从云端免费获取全站方案</a>&gt;&gt;应用推送<a href="AddTemplate.aspx">[生成应用模版]</a></div>
