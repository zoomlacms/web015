<%@ page language="C#" autoeventwireup="true" inherits="manage_APP_AddAPP, App_Web__az9qmx6" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<%}%> 后台管理&gt;&gt;系统设置&gt;&gt;<a href="<%=PageAction.customPath2 %>Template/TemplateSet.aspx">方案设置</a>&gt;&gt;<a href="<%=PageAction.customPath2 %>Template/CloudLead.aspx">从云端免费获取全站方案</a>&gt;&gt;<a href="TemplateSetOfficial.aspx">应用推送</a>&gt;&gt;添加应用模版 </div>
...
<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td>
                            ...
                            <iframe id="Iframe1" style="top: 2px" src="<%=PageAction.customPath2+"Shop/fileupload.aspx?menu=Clearimg" %>" width="100%" height="25px" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
                        </td>
                    </tr>
                    <tr class="tdbg" id="addsmallimg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                        ...
                        <td>
                            <asp:TextBox ID="Thumbnails" runat="server" Width="300px" class="l_input" /><iframe  id="smallimgs" style="top: 2px" src="<%=PageAction.customPath2+"Shop/fileupload.aspx?menu=Thumbnails"%>" width="100%" height="25px" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
                        </td>
                    </tr>
  </table>
