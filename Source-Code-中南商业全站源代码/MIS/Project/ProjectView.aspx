<%@ page language="C#" autoeventwireup="true" inherits="MIS_ProjectView, App_Web_ihm3eyqh" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<script>
    ...
    loadPage("M_toper", "/Mis/header.aspx?hid=6");
