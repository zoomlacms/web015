<%@ page language="C#" autoeventwireup="true" inherits="MIS_Approval, App_Web_qfkgrtvd" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
function loadPage(id, url) {
    ...
    //function SelectUser() {
    //    window.open('/Mis/SelUser.aspx?TypeSelect=UserList&OpenerText=','','width=600,height=450,resizable=0,scrollbars=yes');
    //}
</script>
...
<div class="Approvalli">
    <table width="100%"><tr><td width="150">申请人：</td><td><asp:Label ID="TxtInputer" runat="server" Text=""></asp:Label> </td></tr>
        <tr><td>申请部门：</td><td> 初始化向导 </td></tr>
        <tr><td> 申请流程：  </td><td> <asp:Label ID="lblPro" runat="server"></asp:Label> <a href="#" onclick="PopupDiv2('div_Procedure','lblChecked')">选择流程</a>  </td>  </tr>
        <tr><td>申请内容：</td><td> <asp:TextBox ID="TxtContent" runat="server" TextMode="MultiLine"  Width="300" Height="50" CssClass="M_input"></asp:TextBox></td></tr>
        <tr><td>审批人</td><td><asp:TextBox ID="TxtApprover" runat="server" CssClass="M_input"></asp:TextBox><a href="javascript:void(0)" onclick="PopupDiv2('div_share','lblChecked')">选择</a>  </td></tr>
...
<input type="hidden" id="HidPro" value="123" runat="server" />
