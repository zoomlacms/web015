<%@ page language="C#" autoeventwireup="true" inherits="MIS_Target, App_Web_yuw1lllm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<dd> 
    ...
    <div class="search" >
        ...
        <asp:Button ID="Button1" runat="server" Text="" CssClass="bottom_bg"  OnClick="Button_Click" />
        <div class="clear"></div>
    </div>
 ...
 <dt>事业成功</dt>
    ...
    <div class="new_tar"><a href="AddTarget.aspx">新建目标</a></div>
    <div class="search" >
        <asp:DropDownList ID="DropDownList1" CssClass="b_input" runat="server">
        <asp:ListItem Value="">全部</asp:ListItem>
        <asp:ListItem Value="0">事业</asp:ListItem>
        <asp:ListItem Value="1">财富</asp:ListItem>
        <asp:ListItem Value="2">家庭</asp:ListItem>
        ...
        <asp:TextBox ID="TextBox1" CssClass="b_input" runat="server" Text="请输入关键字" Width="120"  onclick="setEmpty(this)" onblur="settxt(this)"></asp:TextBox>
        <asp:Button ID="Button2" runat="server" Text="" CssClass="bottom_bg"  OnClick="Button_Click" />
        <div class="clear"></div>
    </div>
    <div class="Target_list"> 
        <ul>
