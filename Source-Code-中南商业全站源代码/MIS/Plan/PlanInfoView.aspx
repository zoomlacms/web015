<%@ page language="C#" autoeventwireup="true" inherits="MIS_Plan_PlanInfoView, App_Web_z6u2nz1h" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
function loadPage(id, url) {
    ...
    loadPage("M_toper", "/Mis/header.aspx?hid=4");
</script>
</head>
<body>
<div id="M_toper"> 
