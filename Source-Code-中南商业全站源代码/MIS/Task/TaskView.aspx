<%@ page language="C#" autoeventwireup="true" inherits="MIS_Task_TaskView, App_Web_jrsgt_jv" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
loadPage("M_toper", "../header.aspx?hid=5");
</script>
