<%@ page language="C#" autoeventwireup="true" inherits="MIS_Task_AddTaskInfo, App_Web_ywf3uuzj" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
function loadPage(id, url) {
    ...
    loadPage("M_toper", "/Mis/header.aspx?hid=5");
</script>
</head>
<body>
<div id="M_toper"> 
