<%@ page language="C#" autoeventwireup="true" inherits="MIS_Mail_NewMail, App_Web__p-1wbe-" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
loadPage("M_toper", "../header.aspx?hid=8");
</script>
</head>
<body>
<div id="M_toper"></div>
