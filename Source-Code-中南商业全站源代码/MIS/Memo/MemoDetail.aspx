<%@ page language="C#" autoeventwireup="true" inherits="MIS_Memo_MemoDetail, App_Web_bvilivs7" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        loadPage("M_toper", "../header.aspx?hid=3");
