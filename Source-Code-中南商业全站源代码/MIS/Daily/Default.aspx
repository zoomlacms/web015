<%@ page language="C#" autoeventwireup="true" inherits="MIS_Journal, App_Web_qst_yaah" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html> 
<html>
<head runat="server">
...
<script type="text/javascript">
    ...
    loadPage("M_toper", "/Mis/header.aspx?hid=2");
    var myDate = new Date();
