<%@ page language="C#" autoeventwireup="true" inherits="Common_Vote, App_Web_iwky-wjl" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>投票调查</title>
...
<tr><th width="10%" align="left">验证码：</th><td><div class="reg_put">
...
<asp:Label ID="Validateinfo" runat="server" Text=""></asp:Label>
    ...
    <!--/content-->
    <div class="bottom">
            <asp:Button ID="btnSubmit" runat="server" Text="提交" CssClass="btn" OnClick="btnSubmit_Click"/> &nbsp; &nbsp;<%-- OnClientClick="return CheckAns();" --%>
        <input type="button" value="打印" onclick=" CheckAns();" CssClass="btn" />
