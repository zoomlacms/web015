...
public class getContent : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.Write("<script>uParse('.content',{"+"'highlightJsUrl':'../third-party/SyntaxHighlighter/shCore.js',"+"'highlightCssUrl':'../third-party/SyntaxHighlighter/shCoreDefault.css'"+"})"+"</script>");
        context.Response.Write("First value");
