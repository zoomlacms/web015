<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.RegisterCheck, App_Web_hhz41g8f" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<h2>站长通道</h2>
<h3><a href="<%=PageAction.customPath2 %>login.aspx" target="_blank">进入后台管理</a></h3>
</div>
</div>
<!-- 左边结束 -->
