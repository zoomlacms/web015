<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.page.Shop.AddProduct, App_Web_iwlfzaij" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<script language="JavaScript" type="text/JavaScript">
        ...
        {
            window.open('<%=PageAction.customPath2%>Shop/Producerlist.aspx', '', 'width=600,height=450,resizable=0,scrollbars=yes');
        }
        ...
        {
            window.open('<%=PageAction.customPath2%>Shop/Brandlist.aspx??producer=' + document.getElementById('Producer').value + '', '', 'width=600,height=450,resizable=0,scrollbars=yes');
