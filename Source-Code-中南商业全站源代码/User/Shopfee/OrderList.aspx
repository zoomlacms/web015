<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.User.Shopfee.OrderList, App_Web__xa-iexi" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <asp:Repeater ID="Orderlisttable" runat="server">
                <ItemTemplate>
                    <tr class="tdbg" id="<%#Eval("id") %>" onmouseover="this.className='tdbgmouseover'" ondblclick="getinfo(this.id)" onmouseout="this.className='tdbg'">
                        ...
                        <td style="height: 24px" align="center">
                            <a onclick="opentitle('<%=PageAction.customPath2 %>User/Userinfo.aspx?id=<%#Eval("userId") %>','查看会员')" href="#" title="查看会员">
                        ...
                        <td style="height: 24px" align="center">
                            <a href="#" onclick='javascript:window.open("<%=PageAction.customPath2 %>Common/Extra.aspx?OrderID=<%#Eval("id")%>","","width=600,height=450,resizable=0,scrollbars=yes");'>
                                其他费用</a>
                        </td>
                    </tr>
                </ItemTemplate>
