<%@ page language="C#" autoeventwireup="true" inherits="User_Main, App_Web_udbctae-" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
function goforum_program() {
    Load('Content/ContentLeft.aspx', '<%=PageAction.customPath2%>AddOn/ProjectsList.aspx')
    Showtib(1);
}
