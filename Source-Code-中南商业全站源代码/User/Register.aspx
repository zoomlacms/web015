<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Register, App_Web_hhz41g8f" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="reg">
    ...
    <div class="reg_sub">
        ...
        <ul>
            <li>
                <div class="reg_put">
                    <asp:DropDownList ID="DropDownList1" runat="server" CssClass="input_out" style="height:24px;">
