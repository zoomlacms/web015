 <%@ page language="C#" autoeventwireup="true" inherits="User_Left, App_Web_iqfodgts" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<li> <a href="<%=PageAction.customPath.Replace("~","") %>AddOn/ProjectsList.aspx" target="main_right"><%=lang.Get("u_ContentLeft_item")%></a></li>
<li><a href="<%=PageAction.customPath.Replace("~","") %>AddOn/UserAddProjects.aspx"target="main_right"><%=lang.Get("u_ContentLeft_add")%></a></li>
