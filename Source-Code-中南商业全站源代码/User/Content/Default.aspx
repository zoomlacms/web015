<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.Default, App_Web_iqfodgts" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>内容管理</title>
...
<div style="width: 80%; float: left">
 <iframe id="I2" style="border-style: none; border-color: inherit; border-width: 0px;
        width: 100%; height:1200px;" src="MyContent.aspx" frameborder="0" scrolling="no"
        name="I2"></iframe>
