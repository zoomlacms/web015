<%@ page language="C#" autoeventwireup="true" inherits="User_PreViewOrder, App_Web_udbctae-" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<script type="text/javascript">
	...
	function SelectSuspend() {
		...
		msgDetail.innerHTML = "<p align=center><iframe src=''<%=PageAction.customPath2%>shop/Suspendedinfo.aspx?type=2&id=" + ordreid + "' width='550' height='310' scrolling='no' frameborder='0'></iframe></p>"
	}
	///付款状态
	function SelectState() {
		...
		var ordreid = document.getElementById("orderID").value;
		msgObj.style.display = bgObj.style.display = "block";
		msgDetail.innerHTML = "<p align=center><iframe src='<%=PageAction.customPath2%>shop/OrderStateManage.aspx?type=2&id=" + ordreid + "' width='550' height='510' scrolling='no' frameborder='0'></iframe></p>"
	}
</script>
</body>
</html>