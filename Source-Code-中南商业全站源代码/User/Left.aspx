<%@ page language="C#" autoeventwireup="true" inherits="User_Left, App_Web_hhz41g8f" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<li><a href="../Questions/Default.aspx" target="main_right" ><%=lang.Get("u_Left_goup")%></a></li>
    ...
    <div style="text-align:center; margin-left:8px;margin-top:60px;font-size:12px;color:#1c5f85">
        <asp:Label ID="remindInfo" Text="你的二维码名片" runat="server"></asp:Label>
        <br/><br />
