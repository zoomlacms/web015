<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_StoreOrder, App_Web_tbl8i22i" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>订单详情</title>
...
<script>
    ...
    function SelectTicState() {
        ...
        msgDetail.innerHTML = "<p align=center><iframe src='<%=PageAction.customPath2%>shop/Ordertic.aspx?type=1&id=" + ordreid + "' width='550' height='430' scrolling='no' frameborder='0'></iframe></p>"
    ...
    function SelectOrderState() {
        ...
        var ordreid = document.getElementById("orderID").value;
        msgObj.style.display = bgObj.style.display = "block";
        msgDetail.innerHTML = "<p align=center><iframe src='<%=PageAction.customPath2%>shop/OrderSelState.aspx?type=1&id=" + ordreid + "' width='550' height='510' scrolling='no' frameborder='0'></iframe></p>"
    ...
    function SelectState() {
        ...
        var ordreid = document.getElementById("orderID").value;
        msgObj.style.display = bgObj.style.display = "block";
        msgDetail.innerHTML = "<p align=center><iframe src='<%=PageAction.customPath2%>shop/OrderStateManage.aspx?type=1&id=" + ordreid + "' width='550' height='510' scrolling='no' frameborder='0'></iframe></p>"
    ...
    function SelectDelivery() {
        ...
        var ordreid = document.getElementById("orderID").value;
        msgObj.style.display = bgObj.style.display = "block";
        msgDetail.innerHTML = "<p align=center><iframe src='<%=PageAction.customPath2%>shop/OrderDeliverinfo.aspx?type=1&id=" + ordreid + "' width='550' height='470' scrolling='no' frameborder='0'></iframe></p>"
    }
    ...
    function SelectSign() {
        ...
        var ordreid = document.getElementById("orderID").value;
        msgObj.style.display = bgObj.style.display = "block";
        msgDetail.innerHTML = "<p align=center><iframe src='<%=PageAction.customPath2%>shop/OrderSigninfo.aspx?type=1&id=" + ordreid + "' width='550' height='410' scrolling='no' frameborder='0'></iframe></p>"
    }
    //延迟/暂停处理状态
    function SelectSuspend() {
        ...
        var ordreid = document.getElementById("orderID").value;
        msgObj.style.display = bgObj.style.display = "block";
        msgDetail.innerHTML = "<p align=center><iframe src='<%=PageAction.customPath2%>shop/Suspendedinfo.aspx?type=1&id=" + ordreid + "' width='550' height='310' scrolling='no' frameborder='0'></iframe></p>"
    }
