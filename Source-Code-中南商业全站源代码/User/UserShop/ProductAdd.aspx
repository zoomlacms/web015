<%@ page language="C#" autoeventwireup="true" inherits="User_UserShop_ProductAdd, App_Web_8prky8tx" validaterequest="false" enableviewstate="False" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                                ...
                                <tr class="tdbg">
									...
									<tr class="tdbg">
										...
										<td>
											...
											<input type="button" value="选择模板" onclick="WinOpenDialog(<%=PageAction.customPath2+"Template/TemplateList.aspx?OpenerText="%>+escape('ModeTemplate')+'&FilesDir=',650,480)" class="btn" />
										</td>
