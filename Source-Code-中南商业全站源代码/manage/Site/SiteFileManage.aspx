<%@ page language="C#" autoeventwireup="true" inherits="manage_IISManage_IISFileManage, App_Web_rhqdlbvz" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<link type="text/css" href="../../Plugins/JqueryUI/ProgressBar/css/jquery.ui.all.css" rel="stylesheet" />
	        ...
	        $.ajax({
	            ...
	            success: function (data) {
	                ...
	                else if(a=="getUnZipProg"&&data == "100")
	                {
	                    ...
	                    clearInterval(interval);
	                    alert('解压完成，点击确定开始安装');
	                    $("#<%=beginSetup.ClientID%>").trigger('click');
	                }
	                else
	                {
...
<body>
  ...
  <div id="site_top">
<div id="site_top_l"><div id="site_logo"><a href="Default.aspx"><img src="<%Call.Label("{$LogoUrl/}"); %>" alt="<%Call.Label("{$SiteName/}"); %>" /></a></div>
<div id="site_top_lr"><strong><a href="Default.aspx">站群管理中心</a> </strong><a href="Default.aspx">首页</a>|<a href="../Default.aspx">经典后台</a> |
<a href="javascript:modalDialog('/Common/calc.html', 'calculator', 400, 300)">计算器</a></div></div>
<div id="site_top_r">
<div id="site_top_t">
...
<li  class="site07"><a href="SiteDataCenter.aspx">数据中心</a></li>
<li  class="site06"><a href="#">服务列表</a></li>
</ul>
...
<div id="m_site"><p> 站群中心 >> <a href="Default.aspx">站点列表</a> >> 文件详情  <a href="SiteDetail.aspx?siteName=<%=Server.UrlEncode(siteName) %>" title="" style="color:red;">[查看网站详情]</a></p></div>
            <div id="site_main">
        ...
        <div>
            ...
            <input type="button" id="downBtn" value="从逐浪官方下载源码"  class="site_button"
                onclick="beginDown();" />
            <asp:Button runat="server" id="unzipbtn" text="解压源码并安装" onclick="UnZipBtn_Click"  class="site_button"/> 
            <asp:Button runat="server" ID="beginSetup" Text="开始安装" OnClick="beginSetup_Click" CssClass="site_button" style="display:none;"/> 
            <script type="text/javascript">
                ...
                $(function () {
                    var s = "请输入文件名,回车搜索";
                    $("#searchText").val(s).css('color', '#666')
...
<!--
    ...
    document.write(year); 
    --> 
        </script> <%Call.Label("{$SiteName/}"); %> All Rights Reserved
      </li>
            </ul>
   </div>
      <div class="clear"></div>
