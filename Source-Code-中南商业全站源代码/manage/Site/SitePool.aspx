<%@ page language="C#" autoeventwireup="true" inherits="IISMain, App_Web_injnyj3b" masterpagefile="~/manage/Site/SiteMaster.master" title="应用程序池列表" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <asp:UpdatePanel runat="server" ID="AppPoolPanel">
                <ContentTemplate>
                    <ZL:ExGridView ID="EGV4" runat="server" DataSourceID="AppPoolData" AllowPaging="True" RowStyle-CssClass="tdbg" AutoGenerateColumns="false"
                        ...
                        EnableModelValidation="True" IsHoldState="true" OnRowDataBound="EGV4_RowDataBound">
                        <Columns>
