<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UrlReWr, App_Web_tnuyrvt4" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div class="r_navigation">
 <%if(GetOpenHelp.IsopenHelp()=="1")
  ...
  <%} %> 后台管理 &gt;&gt; 系统配置 &gt;&gt; <a href="UrlReWr.aspx">栏目变子站管理</a> &nbsp;<a href="addUrlReWr.aspx" style="color:#f00;">[添加栏目变子站]</a>
</div>
