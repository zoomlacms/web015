<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AddPointGroup, App_Web_xtycflud" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>添加积分等级</title>
  ...
  <table width="100%" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <td><asp:TextBox ID="imgUrl" runat='server' class="l_input"></asp:TextBox>
        <iframe id="bigimgs" style="top: 2px" src="<%=PageAction.customPath2 %>Shop/FileUpload.aspx?menu=imgUrl" width="100%" height="25px" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe></td>
    </tr>
  </table>
