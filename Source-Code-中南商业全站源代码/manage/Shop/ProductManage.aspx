<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.ProductManage, App_Web_jz9b6l53" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        <span style="float: right; background: url(../../../Images/ModelIcon/edit.gif) no-repeat left; padding-left: 20px;">
            <a onclick='opentitle("../content/EditNode.aspx?NodeID=<%=this.NodeID %>","配置本节点[ESC键退出当前操作]")' href="javascript:void(0)" title="配置本节点">配置本节点</a></span> 
        ...
        <table  cellpadding="2" border="0" cellspacing="1" style="background:#fff;" class="l_input"><tr ><td> 
                  ...
                  <td></tr></table></div>
                    ...
                    <%=lang.Get("m_ContentManage_Ucity")%>：  <select runat="server" id="selprovince" name="selprovince" onchange="javascript:area()">
                                            </select>
...
<script type="text/javascript">
    ...
    <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
        <tbody id="Tabs">
            <tr class="tdbg">
                <td  height="24" class="tdbgleft" style="width:150px; padding-left: 10px;">
                    <b>商品操作：</b><asp:Label ID="lblAddContent" runat="server" Text=""></asp:Label>
                </td>
               <td class="tdbgleft"><div style=" height: 28px; float: left; padding-top:5px;">
            <b>请选择排列顺序：</b>
    ...
    <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
        <tbody id="Tabss">
            ...
            <tr class="tdbg">
                <td height="24" colspan="14" align="center" class="tdbgleft">
