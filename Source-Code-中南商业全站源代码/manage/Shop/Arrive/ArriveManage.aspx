<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Arrive_ArriveManage, App_Web_fp4fw0o6" enableviewstate="False" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>优惠劵管理</title>
...
<RowStyle CssClass="tdbg" BorderColor="White"></RowStyle>
    </asp:GridView>
</div>
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
    <tr class="tdbg">
