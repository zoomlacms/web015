<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_UserOrderlist, App_Web_jz9b6l53" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>店铺用户订单</title>
...
<div class="r_navigation">后台管理<&gt;&gt;商城管理&gt;&gt; 订单管理&gt;&gt; <a href="UserOrderlist.aspx">店铺订单列表</a><span style="color:Red">
     <asp:Label ID="LblLocation" runat="server" Text=""></asp:Label></span></div>
            ...
            <asp:DropDownList ID="souchtable" runat="server">
              ...
              <asp:ListItem Value="7">下单时间</asp:ListItem>
               ...
               <table  cellpadding="2" border="0" cellspacing="1" style="background:#fff;float:left;margin-left:10px;" class="l_input" ><tr ><td> 
                    ...
                    <asp:Button ID="souchok" runat="server" class="C_sch" OnClick="souchok_Click" /></td></tr></table>
