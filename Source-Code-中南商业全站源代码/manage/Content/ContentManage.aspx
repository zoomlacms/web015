<%@ page language="C#" debug="true" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ContentManage, App_Web_rjgkjy--" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div class="r_navigation">
        <table style="float: right;margin-right: 20px;"><tr><td width="25">
            <input type="button" class="C_schmor" title="显示扩展搜索" value="" onclick="displayToolbar()" /> 
            </td><td>
            <img src="../../../Images/ModelIcon/edit.gif"  style="margin-top:2px;margin-right:3px;"/>
             </td>
            <td>
...
<script type="text/javascript">
    ...
    <asp:GridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="GeneralID"
        PageSize="500" OnRowDataBound="Egv_RowDataBound" OnPageIndexChanging="Egv_PageIndexChanging"
    ...
    <asp:CheckBox ID="CheckBox2" runat="server" AutoPostBack="True" Font-Size="9pt"
        Text="全选"  onclick="javascript:CheckAll(this)" />
