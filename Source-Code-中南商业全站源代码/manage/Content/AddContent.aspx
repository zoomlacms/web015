<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Content.AddContent, App_Web_hy2ojcfu" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <table style="width: 100%; margin: 0 auto;" cellpadding="2" cellspacing="1" class="border">
        ...
        <tbody id="Tabs1" style="display: none">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    ...
                    <asp:TextBox ID="txtdate" runat="server" Text="" onClick="WdatePicker()" Width="20%" CssClass="l_input"></asp:TextBox>
        ...
        <tr class="tdbgbottom">
          ...
          &nbsp;<asp:Button ID="BtnDoc" CssClass="C_input" runat="server" OnClientClick="return generate2('docTitle','docParamValue');" OnClick="BtnDoc_Click" Text="生成文档" Visible="false"/>
