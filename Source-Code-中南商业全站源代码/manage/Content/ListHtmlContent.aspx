<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ListHtmlContent, App_Web_hy2ojcfu" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="r_navigation">后台管理&gt;&gt; <a href="ContentManage.aspx">内容管理</a>&gt;&gt;<asp:Label ID="Label1" runat="server" Text="生成管理"></asp:Label></div>
<div class="divline" style="padding-left: 10px">
	<ul>
        ...
        <li style="float:left;">
			...
			<asp:TextBox ID="TextBox1" class="l_input" runat="server" BorderColor="#fff" CssClass="l_inpnon"></asp:TextBox></td><td>
			<asp:Button ID="Button4" runat="server" Text="" OnClick="Button4_Click" class="C_sch" />
                </td></tr></table>
		</li></ul>
</div>
<div class="clearbox">
