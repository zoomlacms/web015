<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.EditSinglePage, App_Web_uouh3twy" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
	...
	<tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
		...
		<td>
			...
			<ContentTemplate>
			<asp:TextBox ID="TxtNodeName" class="l_input" AutoPostBack="true"  runat="server" Columns="30"  ontextchanged="TxtNodeName_TextChanged" onkeyup="Getpy('TxtNodeName','TxtNodeDir')"></asp:TextBox>
