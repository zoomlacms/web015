<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="ZoomLa.WebSite.Manage.Content.CreateHtmlContent, App_Web_uouh3twy" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border" align="center" id="crt1" name="crt1">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
           <td align="right">
            ...
            <td class="bqright"> <asp:TextBox ID="txtNewsCount" style="margin-left:12px;" class="l_input" runat="server"></asp:TextBox><%=lang.Get("M_CreateHtmlContent_piece")%>
