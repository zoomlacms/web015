<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.NodeTree, App_Web_5evmct9r" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<html>
<head runat="server">
...
<script type="text/javascript">    
    ...
    function search() {
        ...
        window.open('ContentManage.aspx?lblkey=' + LabelName, "main_right");
    }
    function cls() {
...
<li> 
    ...
    <table  cellpadding="2" cellspacing="1" class="l_input" style="background:#fff;"><tr><td>
        <asp:TextBox ID="Lname" runat="server"  class="l_inpnon" style="color:#666; width:150px; height:20px; "
            Text="请输入文章标题" onfocus="if (this.value == '请输入文章标题') { this.value = ''; this.style.color = 'black';}"
               onblur="if(this.value==''){this.value='请输入文章标题';this.style.color='#666;width:150px; height:20px;  ';}" 
