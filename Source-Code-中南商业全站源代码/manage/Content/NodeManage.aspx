<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.NodeManage, App_Web_hy2ojcfu" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="border" align="center">
	...
	<asp:Repeater ID="Repeater1" runat="server">
		<ItemTemplate>
            	<tr class="tdbg list<%# Eval("ParentID") %>" id='list<%#Eval("NodeID")%>' name="list<%#Getprname(Eval("NodeID"))%>"
    ...
    <br />
    <asp:Button ID="Button3" class="C_input" runat="server" OnClientClick="return confirm('此操作将删除现有站点数据，确认？');" 
        Text="批量删除" OnClick="Button3_Click" />&nbsp
    <asp:Button ID="Button6" class="C_input" runat="server"  OnClientClick="return confirm('你确定要提交选中内容吗？')" Text="提交方案" OnClick="Button6_Click" />
    </form>
</body>
</html>
