...
function PopImage(divID, path, width, heigh) {
    ...
    //添加新节点
    //var divNew = document.getElementById("divImage");
    //var nodes = divNew.childNodes;
    //if (nodes.length > 0)
    //{
    //    divNew.removeChild(nodes[0]);
    //}
    //var image = document.createElement("img");
    //    image.src=path;
    //    image.alt = "预览的图片";
    //    image.resize = true;
    //    image.onload = AutoSetSize(image, 490, 360);
    //divNew.appendChild(image);
}
//自动缩放图片， 居中显示
