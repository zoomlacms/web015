<%@ page language="C#" autoeventwireup="true" inherits="manage_Workload_Subject, App_Web_-bgfrn3i" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<html>
...
<div id="Excel" runat="server" visible="false" style="text-align: center; margin-top: 10px;">
  ...
  <input type="button" id="GetExcel" name="GetExcel" value="生成Excel文件" class="C_input" onclick="GetExcelWithPath('tb','<%=PageAction.customPath2+"content/GetExcel.aspx"%>')" />
</div>
</body>
</html>