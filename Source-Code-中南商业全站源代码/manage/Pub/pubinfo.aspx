<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="manage_Pub_pubinfo, App_Web_ikluuich" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<tr class="tdbg" id="PubLoadstrs" runat="server" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    ...
    <td align="left" height="24" width="80%">
        ...
        /}&nbsp;<span style="color:red;">*</span><font color="blue"><asp:Label ID="Label4" runat="server" ForeColor="#CC3300"></asp:Label>
        &nbsp;设置标签或模板中调用的标签</font>
    </td>
</tr>
