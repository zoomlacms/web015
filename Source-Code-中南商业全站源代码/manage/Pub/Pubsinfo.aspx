<%@ page language="C#" autoeventwireup="true" inherits="manage_Pub_Pubsinfo, App_Web_ikluuich" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    ...
    <asp:CheckBox ID="CheckBox2" runat="server" AutoPostBack="True" Font-Size="9pt" OnCheckedChanged="CheckBox2_CheckedChanged" Text="全选" />
                    ...
                    <td class="tdbgleft" colspan="7" align="center">共
                        ...
                        <asp:TextBox ID="txtPage" runat="server" AutoPostBack="true" CssClass="l_input" Width="30px" />条信息/页  转到第
                        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" />页 
                    </td>
                </tr>
            </table>
     <div class="clearbox">
