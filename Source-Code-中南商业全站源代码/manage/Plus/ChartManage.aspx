<%@ page language="C#" enableviewstatemac="false" autoeventwireup="true" inherits="manage_Plus_ChartManage, App_Web_zf-stwpc" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<html>
...
<script type="text/javascript">
    ...
    function Move(cla) {
        ...
        var srcva = "";
        srcva = "<%=PageAction.customPath2%>Charts/Show.aspx?Did=" + cla + "&height=300&width=400";
