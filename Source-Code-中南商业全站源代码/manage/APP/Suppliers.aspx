<%@ page language="C#" autoeventwireup="true" inherits="manage_APP_Suppliers, App_Web_ntnuqcim" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<html >
<head runat="server">
<title>APP配置</title>
        ...
        <tbody id="Tabs0">
          ...
          <tr class="tdbg">
            ...
            <td><asp:Button ID="Button5" class="C_input" runat="server" Text="配置" onclick="Button5_Click" />
              <span id="Span1" style="display:none">
                 <span style="color:Green;font-size:13px;">App Key：</span>
              <input id="ASina" type="text" class="Cksele" value="" runat="server" style="width:240px"/>
                 <span style="color:Green;font-size:13px;">App Secret：</span>
              <input id="SSina" type="text" class="Cksele" value="" runat="server"  style="width:240px" />
                 <span style="color:Green;font-size:13px;">回调地址：</span>
          ...
          <tr class="tdbg">
            ...
            <td><asp:Button ID="Button6" class="C_input" runat="server" Text="配置" onclick="Button6_Click" />
              ...
              <input id="AQQ" type="text" class="Cksele" value="" runat="server" style="width:240px"/>
                  <span style="color:Green;font-size:13px;">App ID：</span>
          ...
          <tr class="tdbg">
            ...
            <td><asp:Button ID="Button1" class="C_input" runat="server" Text="配置" onclick="Button1_Click" />
              <span id="CkBaidu_1" style="display:none"><span style="color:Green;font-size:13px;">App Key：</span>
          ...
          <tr class="tdbg">
            ...
            <td><asp:Button ID="Button3" class="C_input" runat="server" Text="配置" 
              ...
              <span id="CkRenren_1"  style="display:none"> <span style="color:Green;font-size:13px;">App Key：</span>
