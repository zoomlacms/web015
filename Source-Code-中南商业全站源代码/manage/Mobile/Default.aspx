<%@ page language="C#" autoeventwireup="true" inherits="manage_Mobile_Default, App_Web_skppbere" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html> 
<html>
<head runat="server">
...
a:active {text-decoration:none ; color:white;} 
    ...
    <script type="text/javascript">
        function Signout()
        {
            window.location = '/manage/SignOut.aspx';
        }
        function JumpToOrder() {
            window.location = '/manage/Shop/OrderList.aspx'
        }
        function JumpToUser() {
            window.location = '/manage/User/UserManage.aspx'
        }
        function JumpToCRM() {
            window.location = '/manage/AddCRM/CustomerList.aspx?usertype=0'
        }
        function JumpToAnswer() {
            window.location = '/manage/iServer/BiServer.aspx'
        }
    </script>
</head>
<body>
