<%@ page language="C#" autoeventwireup="true" enableviewstatemac="false" inherits="manage_Flex_Chart, App_Web_1ldwb_ga" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
...
//        })
    ...
    function tBopen(ty) {
        ...
        if (ty == 1) {
            if (obj.tbtype == "饼状图") {
                obj.tbsrc.attr("src", "<%=PageAction.customPath2%>Charts/pie-basic.aspx?Cid=" + '<%=Request["ChartID"] %>');
            } else if (obj.tbtype == "线状图") {
                obj.tbsrc.attr("src", "<%=PageAction.customPath2%>Charts/line.aspx?Cid=" + '<%=Request["ChartID"] %>');
            } else if (obj.tbtype == "柱状图") {
                obj.tbsrc.attr("src", "<%=PageAction.customPath2%>Charts/colum.aspx?Cid=" + '<%=Request["ChartID"] %>');
            }
        } else if (ty == 2) {
            if (obj.tbtype == "饼状图") {
                obj.tbsrc.attr("src", "<%=PageAction.customPath2%>Charts/pie-basic.aspx?Cid=0&wihi=" + obj.tbwidth + "|" + obj.tbheight);
            } else if (obj.tbtype == "线状图") {
                obj.tbsrc.attr("src", "<%=PageAction.customPath2%>Charts/line.aspx?Cid=0&wihi=" + obj.tbwidth + "|" + obj.tbheight);
            } else if (obj.tbtype == "柱状图") {
                obj.tbsrc.attr("src", "<%=PageAction.customPath2%>Charts/colum.aspx?Cid=0&wihi=" + obj.tbwidth + "|" + obj.tbheight);
            }
        } else if (ty == 3) {
            if (obj.tbtype == "饼状图") {
                obj.tbsrc.attr("src", "<%=PageAction.customPath2%>Charts/pie-basic.aspx?Bases=" + obj.tbwidth + "|" + obj.tbheight + "|" + obj.tbtitle + "|" + obj.tbunit + "&Datas=" + obj.tbbase);
            } else if (obj.tbtype == "线状图") {
                obj.tbsrc.attr("src", "<%=PageAction.customPath2%>Charts/line.aspx?Bases=" + obj.tbwidth + "|" + obj.tbheight + "|" + obj.tbtitle + "|" + obj.tbunit + "&Datas=" + obj.tbbase);
            } else if (obj.tbtype == "柱状图") {
                obj.tbsrc.attr("src", "<%=PageAction.customPath2%>Charts/colum.aspx?Bases=" + obj.tbwidth + "|" + obj.tbheight + "|" + obj.tbtitle + "|" + obj.tbunit + "&Datas=" + obj.tbbase);
            }
        }
