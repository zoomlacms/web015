<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.index, App_Web_3kre4f2z" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="height: 24px; font-size: 12px">
                                                    ...
                                                    <input id="cn11" name="cContent" type="checkbox" checked="checked" />百科问答
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="height: 24px; font-size: 12px">
                                                   ...
                                                   <%-- <input id="fbi4" name="fBI" type="checkbox" checked="checked" />选 号系统--%>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="height: 24px; font-size: 12px">
                                                    ...
                                                    <%--<input id="obi4" name="oBI" type="checkbox" checked="checked" />选 号系统--%>
                ...
                <td colspan="3" valign="top" align="left">
                    <div id="Announce">
                        ...
                        <p>
                            ...
                            <a href="Site/Guide.aspx" title="站群模式">站群模式</a>
                    ...
                    <div id="SubMenu">
                        ...
                        <div id="Menu_4" style="width: 100%; display: none;">
                            <ul>
                                ...
                                { %>
                                <li><a href="javascript:void(0);" onclick="ShowHideLayer(11,4)" onmouseover="showmenu(event,'<div class=menuitems><a href=javascript:void(0) onclick=open_title(\'/manage/Content/ModelManage.aspx?ModelType=6\')><%= lang.Get("m_shopssetting") %></a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/StoreStyleManage.aspx\')><%= lang.Get("m_busintem") %></a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/ProductManage.aspx\')><%= lang.Get("m_merchant") %></a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/ManageModel.aspx\')><%= lang.Get("m_shopmodel") %></a></div><div class=menuitems><a href=javascript:void(0) onclick=open_title(\'UserShopManage/ShopinfoManage.aspx\')><%= lang.Get("m_storeconfig") %></a></div>')"
                                    style="font-weight: bold">
...
<li><a href="mobile/" target="main_right" class="cliimg"><img src="../../App_Themes/AdminDefaultTheme/Images/system16.png" alt="移动管理" /></a> <span><a href="mobile/" target="main_right">移动管理</a></span></li>
