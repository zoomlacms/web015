<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_Sql, App_Web_jpxj23yv" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>SQL执行</title>
    ...
    <tr class="tdbg">
        <td colspan="2">
            <div style="width:500px; height:220px;">
                <div>
                    <input type="text" runat="server" id="start" onblur="setday(this);" onclick="setday(this);" style="width:130px;" /><label id="lbStart" style="color:red;display:none;">*</label>
                    <input type="text" runat="server" id="end"  onblur="setday(this);" onclick="setday(this);" style="width:130px;" /><label id="lbEnd" style="color:red;display:none;">*</label>
