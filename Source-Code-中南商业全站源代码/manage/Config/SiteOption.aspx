<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.SiteConfig.SiteOption, App_Web_jpxj23yv" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
  ...
  <table width="99%" cellspacing="1" cellpadding="0" class="border">
    ...
    <tbody id="ClientApiOpton" runat="server">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td style="padding-left:8px;"><asp:RadioButton ID="txtDowntrue" runat="server" GroupName="UrlWrite" TabIndex="1"
                        Text="是" />
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      <td class="tdbgleft" style="width: 200px; height: 23px;"><strong>启用系统帮助：</strong></td>
       <td><div style="float:left;"><asp:RadioButtonList ID="IsOpenHelp" RepeatDirection="Horizontal" AutoPostBack="True" runat="server" onselectedindexchanged="IsOpenHelp_SelectedIndexChanged">
         <asp:ListItem Value="1">开启</asp:ListItem>
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <td style="padding-left:8px;"><asp:RadioButton ID="rdoUwTrue" runat="server" GroupName="UrlWrite" TabIndex="1" Text="开启" />
        <asp:RadioButton ID="rdoUwFalse" runat="server" GroupName="UrlWrite" TabIndex="2" Text="关闭" /></td>
    </tr>
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
...
('../Template/TemplateList.aspx?OpenerText='+escape('txtShopTemplate')+'&FilesDir=',650,480)" class="C_input" /></td>
    ...
    <tbody id="Tabs2" style="display: none">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td style="padding-left:6px;"><asp:RadioButton ID="rdoEmcTrue" runat="server" GroupName="EnableSiteManageCod" TabIndex="1"
                    Text="是" />
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td style="padding-left:6px;"><asp:RadioButton ID="rdoEskTrue" runat="server" GroupName="EnableSoftKey" TabIndex="1"
                    Text="是" />
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td style="padding-left:6px;"><asp:RadioButton ID="rdoSendMessageTrue" runat="server" GroupName="OpenSendMessage"
                    TabIndex="1" Text="是" />
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td><asp:RadioButtonList ID="rdoIsSensitivity" runat="server" RepeatDirection="Horizontal">
            <asp:ListItem Selected="True" Value="1">是</asp:ListItem>
            <asp:ListItem Value="0">否</asp:ListItem>
          </asp:RadioButtonList> </td>   
        </tr>
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td style="padding-left:8px;">
          <asp:RadioButton ID="IsSaveRemoteImageFalse" runat="server" GroupName="IsSaveRemoteImage"
                    TabIndex="2" Text="不启用" />
            <asp:RadioButton ID="IsSaveRemoteImageTrue" runat="server" GroupName="IsSaveRemoteImage"
                    TabIndex="1" Text="启用" />  *仅针对Ckeditor
</td>
      </tr>
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    ...
    <tbody id="Tabs4" style="display: none">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <div id="Api" runat="server" visible="false"><asp:TextBox ID="TB_Api" runat="server" CssClass="l_input"></asp:TextBox>
          &nbsp;
        <font color="red">提示：用于商城网店查询订单，<a href="http://www.kuaidi100.com/openapi/" target="_blank" style="color:#f00;text-decoration:underline;" >点此申请快递100集成密钥</a>。</font> </div> </ContentTemplate></asp:UpdatePanel> </td>
      </tr>
       <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
