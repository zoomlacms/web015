<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_BackupRestore, App_Web_bq-cs-3r" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    { %>
            ...
            <%} %>
            <a href="/manage/">后台管理</a> &gt;&gt;扩展功能&gt;&gt;<a href="RunSql.aspx">开发中心</a>&gt;&gt;<a href="DatalistProfile.aspx"> 系统概况</a>&gt;&gt; <a href="BackupRestore.aspx">备份数据库</a>
        </div>
