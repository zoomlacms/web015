<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableviewstatemac="false" inherits="ZoomLa.WebSite.Manage.Template.labelSql, App_Web_zd3gwqjl" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<%--                <tr>
            ...
            <table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
              ...
              <tr>
                <td colspan="2" align="center"><asp:DropDownList ID="DropDownList4" runat="server" AutoPostBack=true OnSelectedIndexChanged="DropDownList4_SelectedIndexChanged">
                  ...
                  <input id="Button7" type="button" class="C_input" style="width: 110px;" value="取　消" onclick="window.location.href='LabelManage.aspx'" style="cursor: pointer; " /></td>
              </tr>
            </table>
       ...
       <script>   var sn = document.getElementById("Wizard1_DatabaseList");
