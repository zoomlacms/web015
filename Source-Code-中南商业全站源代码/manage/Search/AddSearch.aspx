<%@ page language="C#" autoeventwireup="true" inherits="manage_Search_AddSearch, App_Web_w-r1pwuz" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>新增导航</title>
                    ...
                    <tbody id="Tabs1">
                        ...
                        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="rdoOpenType" runat="server">
